    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans flex flex-col items-center justify-center p-4 overflow-hidden selection:bg-[#ff4b2b]/30">
      ...
      >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
          className="block w-full py-5 bg-gradient-to-r from-[#ff416c] to-[#ff4b2b] text-white text-center font-black text-xl uppercase tracking-wider rounded-xl shadow-[0_8px_25px_rgba(255,75,43,0.4)] relative overflow-hidden group"
        >
          <motion.div
            animate={{ x: ['-100%', '200%'] }}
          ...
          />
          <span className="relative">Alter bestätigen zum Antworten</span>
        </motion.a>
